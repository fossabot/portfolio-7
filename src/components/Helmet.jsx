    ...
    render() {
        return (
            <Helmet>
                ...
                <meta name="description" content="Personal portfolio website and resume of Gero Gerke, a Aachen, Germany based Full-Stack- and Android Developer." />
                <meta name="keywords" content="resume, android, web, react, kubernetes, devops, webpack, rust, golang, docker, scala, java, dart, flutter" />
