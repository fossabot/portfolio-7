    ...
    return (
        <div className='AreaOfExpertise'>
            <svg width='22' height='23' xmlns='http://www.w3.org/2000/svg'>
                ...
                >
                    <path d='M21 10.91v.9a9.88 9.88 0 0 1-7.16 9.46A10.07 10.07 0 0 1 2.6 17.18 9.76 9.76 0 0 1 3.4 5.4a10.1 10.1 0 0 1 11.67-2.6' />
                    <path d='M21 3.93L11 13.8l-3-2.96' />
                </g>
            </svg>
            <div>
                <div>
...
function Section(props) {
    return (
        <article className={`Section ${props.className}`}>
            ...
            {props.skillSections.map((skillSection) => (
                <AreaOfExpertise
...
Section.propTypes = {
    ...
    skillSections: PropTypes.array.isRequired,
...
export default function Skills() {
    ...
    return (
        <section className='Skills'>
            <Section className='leftSection' {...data.leftSkillSection} />
            <Section className='mainSection' {...data.middleSkillSection} />
            <Section className='rightSection' {...data.rightSkillSection} />
        </section>
    );
}
